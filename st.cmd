...
## Setup EVR devices
mrmEvrSetupPCI("EVR1","05:00.0")
mrmEvrSetupPCI("EVR2","07:00.0")
...
dbpf("mtca1c1s14gTest-DlyGen:0:evr1:Evt:Trig0-SP", "125")
...
## Event code 0x7D (Concentrator interrupt event) --> 150 Hz
## Trigger via Front0 input
dbpf("mtca1c1s14gTest{evg-TrigEvt:1}EvtCode-SP", "125")
